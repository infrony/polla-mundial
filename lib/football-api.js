...
// Returns all games from API with Spanish team names + localDate, for knockout bracket sync
export async function fetchAllGamesRaw() {
  ...
  return allGames
    ...
    .map(g => {
      ...
      return {
        apiId:     g.id,
        homeEs:    resolveTeam(g.home_team_name_en),
        awayEs:    resolveTeam(g.away_team_name_en),
