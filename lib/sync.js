...
export async function runSync(mode = 'today') {
  ...
  // Knockout bracket auto-sync disabled: the API has been returning incorrect
  // results and team positions for the knockout stage. Eliminatorias are now
  // entered manually from the admin panel.
  const knockoutAutoUpdated = [];
