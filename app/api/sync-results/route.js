...
import { fetchFixtures, TEAM_MAP, FINISHED_STATUSES } from '@/lib/football-api';
import { matches } from '@/lib/data';

// Build lookup: "TeamEs|TeamEs" → { matchId, t1, t2, reversed }
...
export async function POST(req) {
  ...
  for (const fix of fixtures) {
    ...
    // Store elapsed as part of status (e.g. "1H:35")
